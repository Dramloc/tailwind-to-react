// Adapted from https://unpkg.com/babel-plugin-macros@3.0.0/dist/index.js
...
function macrosPlugin(
  babel, // istanbul doesn't like the default of an object for the plugin options
  // but I think older versions of babel didn't always pass options
  // istanbul ignore next
  { require: _require, resolvePath, isMacrosName = testMacrosRegex, ...options } = {}
) {
...
function applyMacros({
  ...
  const requirePath = resolvePath(source, ".");
